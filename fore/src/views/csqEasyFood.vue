    ...
    <div class="food">
        ...
        <div class="food_class">
          <ul class="nav">
            ...
            <li>
              <router-link to="/csqEasyFood">简餐便当</router-link>
            </li>
            <li v-for="(item,index) in list6"
            :key="index">
              <router-link to="/csqFood">{{list6[index].name}}</router-link>
            </li>
          </ul>
...
(3)+'.'+list5[index].image_url.substr(32)+'?imageMogr/format/webp/thumbnail/!80x80r/gravity/Center/crop/80x80/'">
        ...
        <div class="main">
          <transition name="restaurant">
            <div class="restaurant-categroy2">
              <div>
                <span>综合排序</span>
...
export default {
  ...
  mounted () {
    ...
    this.$axios.get(this.urlT + this.url4).then(result => {
      ...
      // console.log(this.list5[0].image_url)
    })
  }
}
</script>
